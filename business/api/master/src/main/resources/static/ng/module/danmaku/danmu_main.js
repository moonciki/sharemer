...
(function ($) {
    ...
    var DanmuPlayer = function (element, options) {
        ...
        this.$ctrlMain.append('<input class="danmu-input ctrl-btn"  type="textarea" placeholder="一触即发" id="danmu_text" max=100 />'); // -> button あ
        ...
        $("body").append('<div id="' + this.id.slice(1, this.id.length) + 'fontTip"  hidden="true">' +
            ...
            '<input type="radio" checked="checked"  name="danmu_position" value=0 />滚动弹幕&nbsp;&nbsp;<input type="radio" name="danmu_position" value=1 />顶端弹幕' +
